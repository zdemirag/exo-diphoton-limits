...
# and configure the corresponding environment on cmslpc condor batch node.
# Version for bash-like shell.
#
# 2011 Gena Kukartsev
#
# Usage:
#        source cmslpc_batch_setup.sh
#
...
export PATH=${PYTHONDIR}/bin:./tardir/root/bin:$PATH
