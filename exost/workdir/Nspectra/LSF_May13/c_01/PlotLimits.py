...
for m in mass:
    ...
    observed[m] = []
    s_observed[m] = []
    fexpected = open("expected_c_01.txt","r")
    fobserved = open("observed_c_01.txt","r")
...
theory_a = array("d",[1.5e-02,5.2e-03,1.8e-03,7.04e-04,2.79e-04,1.14e-04,4.68e-05,1.19e-05,7.7e-06])
...
legend . AddEntry(theory, "G_{KK} c = 0.1","l")
