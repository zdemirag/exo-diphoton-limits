...
print "./LimitMoriond2013 0 1 0 " + str(mass) + " 50 100000 c_01_DiphotonLimits_"+type + " " +type+ " workspaces/ 0 1 1.5 1" + "\n"
...
for i in range(0, 20):
    ...
    oFile.write("./LimitMoriond2013 0 1 0 " + str(mass) + " 50 100000 c_01_DiphotonLimits_"+type + " " +type+ " workspaces/ 0 1 1.5 1" + "\n")    
    oFile.close()
